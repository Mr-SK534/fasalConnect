...
export default function Login() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md bg-white/5 backdrop-blur-none p-8 rounded-2xl shadow-2xl border border-white/10">
        <div className="text-center mb-6">
          <div className="text-4xl mb-2">🌿</div>
          <h1 className="text-3xl font-bold text-white drop-shadow-lg">Welcome back</h1>
          <p className="text-white/90 text-sm mt-1 drop-shadow">Sign in to your FasalConnect account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-white/90 backdrop-blur-sm border border-white/40 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 shadow-lg"
              placeholder="you@example.com or xxxxx xxxxx"
            />
          </div>
          ...
          <div>
            ...
            <div style={{ position: "relative" }}>
              <input
                ...
                className="w-full px-4 py-3 pr-12 bg-white/90 backdrop-blur-sm border border-white/40 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 shadow-lg"
                placeholder="••••••••"
              />
              <button
                type="button"
        ...
        <p className="text-sm text-white font-bold mt-6 text-center drop-shadow">
          ...
          <Link to="/register" className="text-yellow-300 font-extrabold hover:underline">
            Register
          </Link>
        </p>
      </div>
