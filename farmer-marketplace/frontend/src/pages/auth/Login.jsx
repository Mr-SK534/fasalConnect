      ...
      <div className="relative z-10 w-full max-w-md bg-transparent backdrop-blur-none p-6 sm:p-8 rounded-2xl shadow-xl border border-white/10">
        <div className="mb-4 flex justify-end">
          <select
            ...
            className="rounded-lg border border-white/40 bg-white/20 px-3 py-1.5 text-sm font-bold text-white backdrop-blur-xs focus:outline-none focus:ring-2 focus:ring-white/50 cursor-pointer"
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-white/95 text-sm font-medium mt-1 drop-shadow-xs">
            {t("login.subtitle")}
          </p>
        </div>

        {error && (
          <div className="mb-4 text-sm font-semibold text-red-100 bg-red-600/80 backdrop-blur-xs border border-red-400/50 rounded-xl px-3.5 py-2.5 shadow-xs">
            {error}
          </div>
        )}
        ...
        <p className="text-sm text-white font-semibold mt-6 text-center drop-shadow-xs">
          {t("login.noAccount")}{" "}
          <Link
            to="/register"
