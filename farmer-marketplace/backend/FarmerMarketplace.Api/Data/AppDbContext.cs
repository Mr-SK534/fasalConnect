...
namespace FarmerMarketplace.Api.Data
{
    public class AppDbContext : DbContext
    {
        ...
        // ==========================================
        // 1. CORE USER, AUTH & PRODUCT DBSETS
        // ==========================================
        ...
        // ==========================================
        // 2. ORDERING SYSTEM DBSETS
        // ==========================================
        public DbSet<Order> Orders { get; set; }
        public DbSet<OrderItem> OrderItems { get; set; }

        // ==========================================
        // 3. PAYMENTS & ESCROW DBSETS
        // ==========================================
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Order & OrderItems Relationships
            ...
            // Razorpay Payments & Splits Relationships
            ...
            // Routing Optimization & Stops Relationships
            ...
            // Escrow & Financial Ledger Relationships
            ...
            // 1. Seed SuperAdmin User (Name: superadmin, Password: 123456)
            ...
            // 3. Seed Platform Config (27 System Rules)
            modelBuilder.Entity<PlatformConfig>().HasData(
                ...
                new PlatformConfig { Id = 14, Category = "thresholds", Key = "min_order_quantity_kg", Value = "1.0", ValueType = ConfigValueType.Decimal, MinValue = 0.1m, MaxValue = 1000m, RequiresRole = "admin", Description = "Minimum order size in kg" },
